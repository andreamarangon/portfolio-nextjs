...
const ThemeToggle = () => {
  ...
  return (
    <div className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full bg-gray-950/5 p-0.75 text-gray-950 dark:bg-white/10 dark:text-white" id="headlessui-radiogroup-«R65elb»" role="radiogroup">
      <span onClick={() => setTheme("system")} className="rounded-full p-1.5 *:size-7 data-checked:bg-white data-checked:ring data-checked:inset-ring data-checked:ring-gray-950/10 data-checked:inset-ring-white/10 sm:p-0 dark:data-checked:bg-gray-500 dark:data-checked:text-white dark:data-checked:ring-transparent" aria-label="System theme" id="headlessui-radio-«R6m5elb»" role="radio" aria-checked={theme === "system" ? "true" : "false"} data-headlessui-state={theme === "system" ? "checked" : ""} data-checked={theme === "system" ? "" : null}>
        <svg viewBox="0 0 28 28" fill="none">
          ...
          <path d="M7.5 8.5C7.5 7.94772 7.94772 7.5 8.5 7.5H19.5C20.0523 7.5 20.5 7.94772 20.5 8.5V14.5C20.5 15.0523 20.0523 15.5 19.5 15.5H8.5C7.94772 15.5 7.5 15.0523 7.5 14.5V8.5Z" stroke="currentColor">
          </path><path d="M16.5 20.5V17.5H11.5V20.5M16.5 20.5H11.5M16.5 20.5H17.5M11.5 20.5H10.5" stroke="currentColor" strokeLinecap="round">
          </path>
        </svg>
      </span>
      <span onClick={() => setTheme("light")} className="rounded-full p-1.5 *:size-7 data-checked:bg-white data-checked:ring data-checked:inset-ring data-checked:ring-gray-950/10 data-checked:inset-ring-white/10 sm:p-0 dark:data-checked:bg-gray-700 dark:data-checked:text-white dark:data-checked:ring-transparent" aria-label="Light theme" id="headlessui-radio-«Ram5elb»" role="radio" aria-checked={theme === "light" ? "true" : "false"} data-headlessui-state={theme === "light" ? "checked" : ""} data-checked={theme === "light" ? "" : null}>
        <svg viewBox="0 0 28 28" fill="none">
          ...
          </path><path d="M19.5 14L21.5 14" stroke="currentColor" strokeLinecap="round">
          </path><path d="M17.889 17.8885L19.3032 19.3027" stroke="currentColor" strokeLinecap="round">
          </path><path d="M14 21.5V19.5" stroke="currentColor" strokeLinecap="round">
          </path><path d="M8.69663 19.3029L10.1108 17.8887" stroke="currentColor" strokeLinecap="round">
          </path>
    ...
    /*         <button
          type="button"
          className="cursor-pointer bg-[#dcdfe2] dark:bg-gray-700 text-[#1f2937] hover:text-[#3d516b] dark:text-white hover:dark:text-gray-200 hover:bg-hover-background active:bg-active-background rounded-full p-2 [transition:background_20ms_ease-in,_color_0.15s]"
          title="Toggle theme"
          aria-label="Toggle theme"
          onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
        >
          <LuSun className="w-5 h-5 dark:hidden" />
          <LuMoon className="hidden w-5 h-5 dark:block" />
          <svg
